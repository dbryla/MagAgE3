...
/**
 * Represents cluster with informations as members, nodes, topology type, graph
 * and master node.
 *
 */
final class ClusterInfo {
    ...
    void setTopologyGraph(
            UnmodifiableDirectedGraph<String, DefaultEdge> unmodifiableDirectedGraph) {
